        ...
        public static void setCustomButtonCooldowns() {
            if (!initialized) {
                try {
                    ...
                    TheOtherRolesEditedPlugin.Logger.LogWarning("Button cooldowns not set, either the gamemode does not require them or there's something wrong.");
                    return;
                }
            }
        ...
        public static void createButtonsPostfix(HudManager __instance) {
            ...
            hackerVitalsButton = new CustomButton(
               ...
               () => {
                   ...
                   hackerVitalsButton.actionButton.OverrideText(Helpers.isMira() ? "门日志" : "心跳仪");
            ...
            securityGuardCamButton = new CustomButton(
                ...
                () => {
                    ...
                    securityGuardCamButton.actionButton.OverrideText(Helpers.isMira() ? "开门日志" : "监控");
            ...
            yoyoButton = new CustomButton(
                () => {
                    ...
                    {
                        TheOtherRolesEditedPlugin.Logger.LogMessage($"marked location is null in button press");
                    ...
                    {
                        TheOtherRolesEditedPlugin.Logger.LogMessage("in else for some reason");
                        // Jump to location
                        TheOtherRolesEditedPlugin.Logger.LogMessage($"trying to blink!");
            ...
            zoomOutButton = new CustomButton(
                ...
                () => { return true; },
                () => { return; },
                Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.MinusButton.png", 150f),  // Invisible button!
