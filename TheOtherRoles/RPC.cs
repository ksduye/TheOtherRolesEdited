...
using static TheOtherRolesEdited.HudManagerStartPatch;
using static TheOtherRolesEdited.GameHistory;
using static TheOtherRolesEdited.TORMapOptions;
...
namespace TheOtherRolesEdited
{
    ...
    public static class RPCProcedure
    {
        ...
        public static void HandleShareOptions(byte numberOfOptions, MessageReader reader)
        {
            ...
            {
                TheOtherRolesEditedPlugin.Logger.LogError("Error while deserializing options: " + e.Message);
            }
        }
        ...
        public static void workaroundSetRoles(byte numberOfRoles, MessageReader reader)
        {
            for (int i = 0; i < numberOfRoles; i++)
            {
                ...
                {
                    TheOtherRolesEditedPlugin.Logger.LogError("Error while deserializing roles: " + e.Message);
                }
            }
        ...
        public static void engineerUsedRepair()
        {
            ...
            {
                Helpers.showFlash(Engineer.color, 0.5f, "工程师的修理"); ;
            }
        }
        ...
        public static void timeMasterRewindTime()
        {
            ...
            SoundEffectsManager.stop("时间之主的时间之盾");  // Shield sound stopped when rewinding
        ...
        public static void shieldedMurderAttempt()
        {
            ...
            if (isShieldedAndShow || isMedicAndShow || Helpers.shouldShowGhostInfo()) Helpers.showFlash(Palette.ImpostorRed, duration: 0.5f, "医生对玩家进行了保护导致内鬼杀人未遂");
        }
        ...
        public static void jackalCreatesSidekick(byte targetId)
        {
            ...
            else
            {
                ...
                if (player == CachedPlayer.LocalPlayer.PlayerControl) SoundEffectsManager.play("豺狼的跟班");
            }
        ...
        public static void lightsOut()
        {
            ...
            {
                new CustomMessage("骗术师关闭了灯光(无法修理)", Trickster.lightsOutDuration);
            }
        }
        ...
        public static void placeCamera(byte[] buff)
        {
            ...
            camera.CamName = $"监控摄像头 {SecurityGuard.placedCameras}";
            ...
            if (SubmergedCompatibility.IsSubmerged)
            {
                ...
                var fixConsole = camera.transform.FindChild("修复控制台");
                if (fixConsole != null)
                {
        ...
        {
            SoundEffectsManager.play("化形者化形");
        ...
        {
            TheOtherRolesEditedPlugin.Logger.LogMessage($"blink fistjumpo: {isFirstJump}");
